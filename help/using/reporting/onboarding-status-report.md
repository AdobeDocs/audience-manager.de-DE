...
## Fehler-Berichte und Fehlerbearbeitung {#error-reporting-sampling}

Fehler-Berichte und Fehlerberechnung sind zwei verschiedene Funktionen des [!UICONTROL Onboarding Status] Berichts.
...
## Erstellen eines Berichts über den Onboarding-Status {#create-onboard-status-report}

A [!UICONTROL Sample Error Report] gibt die Anzahl der Datensätze in einer Datenquelle zurück, die erfolgreich verarbeitet wurden und wie viele fehlgeschlagen sind. Führen Sie die folgenden Schritte aus, um eine [!UICONTROL Sample Error Report]zu generieren.
...
<table id="table_1D44A2E6B4C847848B818190DD336841"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Liste der Anzahl der Datensätze, deren Verarbeitung fehlgeschlagen ist, da sie nicht den Syntax- oder Formatierungsanforderungen entsprachen. Siehe Inhalt <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> der Inbound-Datendatei: Syntax, Variablen und Beispiele</a> für Informationen zur Formatierung Ihrer Daten. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Ungültige AAM-ID</b> </p> </td> 
   <td colname="col2"> <p>Liste der Anzahl der Benutzer-IDs (UUID) für <span class="keyword"> Audience Manager</span> mit falscher Formatierung. Normalerweise gibt dies die IDs an: </p> 
...
<tr> 
   ...
   <td colname="col2"> <p>Liste der Anzahl falsch formatierter globaler Geräte-IDs. Weitere Informationen dazu, wie Geräte-IDs formatiert werden sollen und welche globalen Datenquellen Sie je nach Gerätetyp verwenden sollten, finden Sie unter <a href="../reference/ids-in-aam.md">IDs in Audience Manager</a> und <a href="../features/global-data-sources.md">Globale Datenquellen</a> .</p>
