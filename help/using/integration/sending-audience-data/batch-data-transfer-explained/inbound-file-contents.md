...
Die Felder in der eingehenden Datendatei müssen in der unten gezeigten Reihenfolge angezeigt werden. In diesem Beispiel wurden die Symbole `<` `>` hinzugefügt, um die einzelnen Elemente visuell zu trennen. Sie müssen diese nicht in Ihre Datendatei aufnehmen.
...
<table id="table_FE043CE392B34D5194111188E5C39671"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Eine Benutzer-ID kann: </p> <p> 
     <ul id="ul_25168355353545A9A049D0083403025E"> 
      <li id="li_23829FE2F6464E33859B3E388FCD106B">Eine Unique User-ID, die von <span class="keyword"> Audience Manager </span> ( <a href="../../../reference/ids-in-aam.md"> Audience Manager-UUID </a>) zugewiesen wird. </li> 
      ...
      <li id="li_52ABF6CCBCD147E2BD84D056F7461BA0">Eine Android- oder iOS-Mobilgeräte-ID in ihrer ursprünglichen, unveränderten Form, wie sie vom mobilen Betriebssystem verfügbar gemacht wird. </li> 
     ...
     <ul id="ul_717A17E11565427E9E2D9D7554BB231B"> 
      ...
      <li id="li_27F298E62A1E46F88ECF52A01B752D3A">Android-Format: IDs müssen in Kleinbuchstaben und nicht mit Hashing geschrieben sein. Beispiel: <code> 97987bca-ae59-4c7d-94ba-ee4f19ab8c21 </code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Kennung der Eigenschaft <span class="keyword"> Audience Manager </span> . Wir möchten Sie bitten, <i>nur integrierte Eigenschaften</i> in eingehende Datendateien aufzunehmen. Bei der eingehenden Datenübertragung werden keine anderen Eigenschaftstypen verarbeitet. </p> <p> <p>Hinweis: Die Eigenschaften-ID kann mithilfe der GET-Methode gefunden werden, die Details zu allen Ihren Eigenschaften zurückgibt. Weitere Informationen finden Sie unter <a href="../../../api/rest-api-main/api-traits.md"> API-Methoden für Eigenschaften </a>. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_AD54B3E5487E47C481A4E5FD3A93FDA5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Das Präfix <code> d_sid </code> teilt unserem System mit, dass die ID eine <span class="keyword"> Audience Manager </span>-Eigenschafts-ID ist. Hierbei handelt es sich um dieselbe ID, die auch in der Benutzeroberfläche angezeigt wird. Sie können Eigenschaften-IDs auch mit der API <code> GET </code> -Methode zurückgeben. Siehe <a href="../../../api/rest-api-main/api-traits.md"> API-Methoden für Eigenschaften </a>. </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> <p> <code> d_unsid= </code> </p> </td> 
   <td colname="col2"> <p>Daten mit dem Präfix <code> d_unsid </code> entfernen Benutzer aus dieser Eigenschaft. Das Präfix <code> d_unsid </code> wird in einer <code> overwrite </code> -Datei ignoriert. </p> <p>Das Präfix <code> d_unsid= </code> teilt unserem System mit, dass die ID eine <span class="keyword"> Audience Manager </span>-Eigenschafts-ID ist. Hierbei handelt es sich um dieselbe ID, die auch in der Benutzeroberfläche angezeigt wird. Sie können Eigenschaften-IDs auch mit der API <code> GET </code> -Methode zurückgeben. Siehe <a href="../../../api/rest-api-main/api-traits.md"> API-Methoden für Eigenschaften </a>. </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> ic= </code> </p> </td> 
   <td colname="col2"> <p> <a href="../../../features/traits/manage-trait-rules.md#managing-trait-rules"> Eigenschaftsregeln </a> ermöglichen es Ihnen, Kriterien für die Eigenschaftsqualifizierung festzulegen. Wenn Sie eine Eigenschaftsregel als <code> ic == trait ID </code> formatieren, können Sie Eigenschaften in einer einfachen, kommagetrennten Liste senden. </p> <p>Angenommen, Sie erstellen diese 3 Eigenschaftsregeln: </p> <p> 
     <ul class="simplelist"> 
      <li> <code> ic == "123" </code> </li>
      <li> <code> ic == "456" </code> </li>
      <li> <code> ic == "789" </code> </li>
     </ul> </p> <p>Diese Eigenschaften sind mit dem Schlüssel <code> ic </code> verknüpft. Auf diese Weise können Sie eine einfachere Eigenschaftsliste in der Datendatei erstellen. Außerdem müssen Sie das Präfix <code> ic </code> nicht einbeziehen. Daher könnte der Inhalt Ihrer Datendatei wie folgt aussehen: </p> <p>
     <code> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
## Ungültige Zeichen in den Paaren [!UICONTROL Trait IDs], [!UICONTROL User IDs] und Schlüssel-Wert {#invalid-chars}

### [!UICONTROL Trait IDs]

[!UICONTROL Trait IDs] besteht nur aus numerischen Zeichen. Wir möchten Sie bitten, *nur[!UICONTROL onboarded traits]* in die eingehenden Datendateien aufzunehmen. Bei der eingehenden Datenübertragung werden keine anderen [!UICONTROL trait]-Typen verarbeitet.
...
<table id="table_8C5C7271B813441EA2D45CA2FE2A6C59"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Verwenden Sie in DPUUIDs kein kodiertes Doppelpunkt ( <code> %3A </code>)- oder nicht kodiertes Doppelsymbol ( : ).<i></i> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Mobilgeräte-IDs müssen wie im Folgenden gezeigt streng formatiert sein: </p> <p> 
     <ul id="ul_6AEFB6CFA54444D9B75F03BCE7916696"> 
      ...
      <li id="li_2DA0347293814C70ADCD253BF01A81F5">Android-Format: IDs müssen in Kleinbuchstaben und nicht mit Hashing geschrieben sein. Beispiel: <code> 97987bca-ae59-4c7d-94ba-ee4f19ab8c21 </code> </li> 
     </ul> </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_41A4991090A64DEFA9AF704164B26DBB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Wir ignorieren Bindestriche am Anfang von Schlüsseln. Beispielsweise wird <code> -product = camera </code> als <code> product = camera </code> interpretiert. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> TAB </code> </p> </td> 
   <td colname="col2"> <p><i>Verwenden Sie nicht </i> <code> TAB </code> anstelle leerer Werte in Schlüssel-Wert-Paaren. Verwenden Sie <code> TAB </code> nur, um Variablen in der eingehenden Datendatei zu trennen. </p> </td> 
  </tr> 
  <tr> 
...
[Laden Sie die Beispieldatendatei herunter](assets/ftp_dpm_1234_1445374061.overwrite), wenn Sie weitere Beispiele benötigen. Die Download-Datei hat die Dateierweiterung &quot;`.overwrite`&quot;. Sie können sie mit einem einfachen Texteditor öffnen.
...
Verwenden Sie [!UICONTROL trait IDs] , um [!UICONTROL trait] disqualifikationsbezogene Informationen für [!DNL Audience Manager] [!DNL UUIDs] zu senden.
...
Verwenden Sie [!UICONTROL trait IDs] , um [!UICONTROL trait] disqualifikationsbezogene Informationen für [!DNL Android] Geräte zu senden.
...
Verwenden Sie [!UICONTROL trait IDs] , um [!UICONTROL trait] disqualifikationsbezogene Informationen für [!DNL iOS] Geräte zu senden.
