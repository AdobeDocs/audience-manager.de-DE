...
<table id="table_455D174BAB9B494D973DA1023F22B962"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Pfad und Name Ihres Amazon S3-Buckets. Wenden Sie sich an Ihren Kundenbetreuer, um den Namen, den Pfad und die Anmeldeinformationen Ihres S3-Ordners zu erhalten. </p> </td> 
  </tr> 
  <tr> 
...
Wenn Sie weitere Beispiele benötigen, können Sie die Beispieldatei [herunterladen](assets/ftp_dpm_1234_1445374061.overwrite). Diese Datei wurde mit der Dateierweiterung `.overwrite` gespeichert. Öffnen Sie es mit einem einfachen Texteditor.

## Zulässige Dateigrößen {#accepted-file-sizes}

Beachten Sie die folgenden Zahlen für die schnellste/früheste Verarbeitung Ihrer Dateien sowie für Dateigrößenbeschränkungen beim Senden von Daten an ein Verzeichnis [!DNL Audience Manager] / [!DNL Amazon S3] .
