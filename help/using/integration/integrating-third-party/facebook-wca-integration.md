...
| `%ALIAS%` | Ein [!DNL Audience Manager] Makro, das dynamisch durch die [!DNL Audience Manager] Segment-IDs ersetzt wird, für die sich der Site-Besucher qualifiziert, mit Komma, |
...
Ordnen Sie im Arbeitsablauf zum [Konfigurieren des URL-Ziels](/help/using/features/destinations/create-url-destination.md) das entsprechende Segment Ihrem neu erstellten Ziel zu. Beachten Sie, dass der Zuordnungswert automatisch mit der [!DNL Audience Manager] Segment-ID ausgefüllt wird.
