...
## Dateiinhalt-Makros {#file-content-macros}
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Format:</b> </p> <p> 
     ...
     </code></p> <p> <p>Hinweis:  Im ersten Beispiel gibt das Makro nur Daten für zurück, <code> SEGMENT_LIST </code> da es leer <code> REMOVED_SEGMENT_LIST </code> ist. Das zweite Beispiel gibt Daten für beide Makros zurück. </p> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_6A6D94F994C1475BB09126BA0B815B1F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <code> [["2222","CCCC"]] </code> </p> <p>Obwohl <code> maxMappings=2 </code>dieses Makro nur 1 DPID an die DPUUID-Zuordnung zurückgibt, da die angegebene DPID nur eine DPUUID hat. </p> </td> 
  </tr> 
 </tbody> 
</table>
