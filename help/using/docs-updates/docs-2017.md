...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ausgabe der neuen Fehlercodes 111, 309 und 310. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Unterstützte Attribute für DCS-API-Aufrufe</a> </p> </td> 
   <td colname="col2"> <p><code> d_cts</code> wurde als optionaler Parameter in der Liste der verfügbaren Schlüssel für DCS-Anforderungen hinzugefügt. Wenden Sie sich zur Aktivierung an Ihren Adobe Audience Manager-Berater oder an die Kundenunterstützung. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-reporting.md"> Häufig gestellte Fragen zur Berichterstellung</a> </p> </td> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Erfahren Sie, warum <span class="wintitle"> Actionable Log Files</span> die empfohlene Methode ist, DCM-Protokolldateien in <span class="keyword"> Audience Manager</span> zu importieren, und lernen Sie, wie Sie mit der Funktion beginnen können. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Schritt 7 wurde hinzugefügt, in dem beschrieben wird, was Sie tun müssen, um <span class="wintitle"> Actionable Log Files</span> zu aktivieren, nachdem Sie den DCM-Datendateiimport in <span class="keyword"> Audience Manager</span> eingerichtet haben. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-details-page.md"> Seite mit Eigenschaftendetails</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Überarbeiteter Inhalt mit neuen Links zum Adobe Privacy Center. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md"> API-Methoden und Code für den Datenerfassungsserver (DCS)</a> </p> </td> 
   <td colname="col2"> <p>Der DCS-API-Inhalt wurde überarbeitet und neu organisiert. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>isCoopSafe </p> </td> 
   <td colname="col2"><i>Diese Funktion wird nicht mehr unterstützt.</i> <p>Eine neue Konfiguration, die steuert, wie Daten an die <span class="keyword"> Experience Cloud Device Co-op</span> gesendet werden. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neuer Inhalt, der beschreibt, wie die Aufhebung der Segmentierung mit <span class="wintitle"> Profilzusammenführungsrichtlinien</span> funktioniert. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Es wurden neue Definitionen hinzugefügt, die berücksichtigen, wie <span class="wintitle"> Regeln zur Profilzusammenführung</span> die Berichtszahlen beeinflussen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-details-page.md"> Ansicht der Eigenschaftszusammenfassung</a> </p> </td> 
   <td colname="col2"> <p>Überlagert zwei neue Metriken in der Ansicht "Eigenschaftszusammenfassung": Eindeutige Eigenschaftsrealisierungen und Gesamtzahl der Eigenschaftspopulationen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/administration/usage-limits.md"> Nutzungsbeschränkungen</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Eigenschafts- und Segmentpopulationsdaten in Segment Builder</a> </p> </td> 
   <td colname="col2"> <p>Änderung einer Metrik von <span class="wintitle"> Realisierungen eindeutiger Eigenschaften</span> in <span class="wintitle"> Gesamtzahl der Eigenschaftspopulation</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md"> FTP-Anforderungen an Namen und Dateigrößen der eingehenden Datendateien..</a> </td> 
   <td colname="col2"> <p>Wir haben die dokumentierte optimale und maximale Dateigröße für komprimierte Dateien erhöht. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md"> Anforderungen an Namen und Dateigrößen der über Amazon S3 eingehenden Daten...</a> </td> 
   <td colname="col2"> <p>Wir haben die dokumentierte optimale und maximale Dateigröße für komprimierte Dateien erhöht. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ein neuer Abschnitt in unserer Dokumentation, in dem verschiedene Anwendungsfälle für die Funktion <span class="wintitle"> Audience Lab</span> beschrieben werden. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Sie können mehrere verschiedene Modelltypen und -quellen in <span class="keyword"> Audience Manager</span> verwenden. <span class="wintitle"> Audience Lab</span> bietet eine einfache Möglichkeit, die Konversionsraten Ihrer Kunden über Ihre aktiven Modelle hinweg zu vergleichen. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Verwenden Sie <span class="wintitle"> Audience Lab</span> , um die Anzahl der Konversionen zu messen, die ein Kreativschaffender über verschiedene Ziele hinweg treibt. In diesem Anwendungsfall können Sie auch die Konversionen des Kreativelements gegenüber natürlich vorkommenden Konversionen messen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> Häufig gestellte Fragen zu Profilzusammenführungsregeln</a> </p> </td> 
   <td colname="col2"> <p>Es wurden neue FAQs hinzugefügt, die bei der Beantwortung häufiger Fragen zu <span class="wintitle"> Profilzusammenführungsregeln</span> und Gerätediagrammen helfen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>DCS HTTP-Antwortaufrufe enthalten jetzt das Feld <code> tid</code> . Verwenden Sie dieses Feld für Debugging-Zwecke im Fall von Vorfällen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>Es wurde ein Hinweis hinzugefügt, der klarstellt, dass Rückblickzeiträume von 7 Tagen und 30 Tagen nur für Sonntag- <b><span class="uicontrol"> Datum bis </span></b> -Daten verfügbar sind. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-dashboard.md"> Ansicht der Eigenschaftsliste</a> </p> </td> 
   <td colname="col2"> <p>Verbesserungen der Benutzeroberfläche hinsichtlich der Suche und Filterung von Eigenschaften im Eigenschaften-Dashboard. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Das optionale Dateinamenelement <code> PID-ALIAS</code> wurde zur Ausgabedatei hinzugefügt. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> Verwendung des DNS-Vorabrufs für verschiedene Experience Cloud-Lösungen</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Beschreibung wurde überarbeitet und zugehörige Links zur Eigenschaft <code> containerSNID</code> von <code> DIL.create</code> hinzugefügt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Adressierbare Zielgruppenmetriken</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/api-swagger-migration.md"> Migration des Audience Manager-API-Codes</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md"> Anforderungen an Namen und Dateigrößen der über Amazon S3 eingehenden Daten...</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde ein neuer Eintrag hinzugefügt, der die <span class="keyword"> Experience Cloud</span> <span class="wintitle"> Organisations-ID</span> beschreibt, einschließlich Informationen dazu, wie sie gefunden werden kann. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>Aktualisierung, um das Makro <code> DPUUIDS</code> einzuschließen. </p> </td> 
  </tr> 
 </tbody> 
</table>
