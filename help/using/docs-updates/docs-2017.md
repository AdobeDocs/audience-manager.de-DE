...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Zu Referenzzwecken haben wir die reservierten Attribute <code> d_dst_filter</code> und <code> d_rs</code> zu den dokumentierten <code> d_</code> hinzugefügt. Wir raten davon ab, Eigenschaften zu erstellen, die reservierte Attribute verwenden. Adobe kann reservierte Attribute jederzeit ändern. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Die Eigenschaftsqualifizierung oder Eigenschaftsrealisierung wird in Audience Manager je nach Eigenschaftstyp unterschiedlich behandelt. Dieses Dokument beschreibt die Qualifizierungsmerkmale für jeden Eigenschaftstyp. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Total Trait Fires wurde in der Benutzeroberfläche von Audience Manager in Total Trait Realisierungen umbenannt. Wir haben die FAQ aktualisiert, um diese Änderung widerzuspiegeln. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Überarbeiteter Inhalt mit neuen Links zum Adobe-Datenschutzzentrum. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="keyword"> Audience Manager</span> können Sie verschiedene Modelltypen und -quellen verwenden. <span class="wintitle"> Audience Lab</span> bietet eine einfache Möglichkeit, die Konversionsraten Ihrer Kunden über Ihre aktiven Modelle hinweg zu vergleichen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde ein neues Dokument hinzugefügt, in dem erläutert wird, warum <span class="keyword"> Audience Manager</span> Aufrufe an die <code> demdex.net</code> Domain durchführt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Audience Manager-Cookies</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Unterstützte Attribute für DCS-API-Aufrufe</a> </p> </td> 
   <td colname="col2"> <p>Das Präfix der Schlüsselvariablen wurde mit <code> _p</code> aktualisiert, wodurch private Parameter in Audience Manager identifiziert wurden. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reference/ids-in-aam.md"> ID-Index in Audience Manager</a> </p> </td> 
   <td colname="col2"> <p>Das erwartete Format für die von <span class="keyword"> Audience Manager</span> verarbeiteten IDs für Mobilgeräte (DAID) wurde aktualisiert. </p> </td> 
  </tr> 
  <tr> 
