...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Zu Referenzzwecken wurden die reservierten Attribute hinzugefügt. <code> d_dst_filter</code> und <code> d_rs</code> zu den dokumentierten <code> d_</code> -Attribute. Wir empfehlen, keine Eigenschaften zu erstellen, die reservierte Attribute verwenden. Die Adobe kann reservierte Attribute jederzeit ändern. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Unterstützte Attribute für DCS-API-Aufrufe</a> </p> </td> 
   <td colname="col2"> <p>Hinzugefügt <code> d_cts</code> als optionalen Parameter in der Liste der verfügbaren Schlüssel für DCS-Anforderungen. Wenden Sie sich zur Aktivierung an Ihren Adobe Audience Manager-Berater oder an die Kundenunterstützung. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Erfahren Sie, warum <span class="wintitle"> Ausführbare Protokolldateien</span> wird empfohlen, DCM-Protokolldateien in <span class="keyword"> Audience Manager</span> und erfahren Sie, wie Sie mit der Funktion beginnen können. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Schritt 7 wurde hinzugefügt, in dem beschrieben wird, was Sie tun müssen, um <span class="wintitle"> Ausführbare Protokolldateien</span> nach der Einrichtung des DCM-Datendateiimports in <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><i>Diese Funktion wird nicht mehr unterstützt.</i> <p>Eine neue Konfiguration, die steuert, wie Daten an die <span class="keyword"> Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neuer Inhalt, der beschreibt, wie die Aufhebung der Segmentierung mit <span class="wintitle"> Profilzusammenführungsrichtlinien</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Mit neuen Definitionen überarbeitet, die berücksichtigen, wie <span class="wintitle"> Profilzusammenführungsrichtlinien</span> sich auf die Berichtsnummern auswirken. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Die <b><span class="uicontrol"> Bearbeiten</span></b> Workflow ermöglicht es Ihnen, die Datenquelle für Ordnereigenschaften zu ändern. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Eigenschafts- und Segmentpopulationsdaten in Segment Builder</a> </p> </td> 
   <td colname="col2"> <p>Änderung einer Metrik in <span class="wintitle"> Eigenschaftspopulation insgesamt</span> von <span class="wintitle"> Eindeutige Eigenschaftsrealisierungen</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ein neuer Abschnitt in unserer Dokumentation, in dem mehrere Anwendungsfälle für die <span class="wintitle"> Audience Lab</span> Funktion. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Sie können verschiedene Arten und Quellen von Modellen in <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> bietet eine einfache Möglichkeit, die Konversionsraten Ihrer Kunden über Ihre aktiven Modelle hinweg zu vergleichen. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Verwendung <span class="wintitle"> Audience Lab</span> , um die Anzahl der Konversionen zu messen, die ein Kreativelement über verschiedene Ziele hinweg treibt. In diesem Anwendungsfall können Sie auch die Konversionen des Kreativelements gegenüber natürlich vorkommenden Konversionen messen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> Häufig gestellte Fragen zu Profilzusammenführungsregeln</a> </p> </td> 
   <td colname="col2"> <p>Es wurden neue FAQs hinzugefügt, die bei der Beantwortung gemeinsamer <span class="wintitle"> Profilzusammenführungsrichtlinie</span> und Fragen zum Gerätediagramm. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>DCS HTTP-Antwortaufrufe enthalten jetzt <code> tid</code> -Feld. Verwenden Sie dieses Feld für Debugging-Zwecke im Fall von Vorfällen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>Es wurde ein Hinweis hinzugefügt, der klarstellt, dass Rückblickszeiträume von 7 Tagen und 30 Tagen nur für Sonntag verfügbar sind <b><span class="uicontrol"> Datum bis</span></b> Daten. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Inhalt wurde überarbeitet, um Folgendes anzugeben: </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">Vor dem Hochladen müssen Dateien mit gzip komprimiert sein und eine <code> .gz</code> Dateierweiterung. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Eigenschafts- und Segmentpopulationsdaten in Segment Builder</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde ein neues Dokument hinzugefügt, in dem erläutert wird, warum <span class="keyword"> Audience Manager</span> sendet Aufrufe an die <code> demdex.net</code> Domäne. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies in Audience Manager</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Unterstützte Attribute für DCS-API-Aufrufe</a> </p> </td> 
   <td colname="col2"> <p>Die Schlüsselvariablenpräfixe wurden aktualisiert mit <code> _p</code>, um private Parameter in Audience Manager zu identifizieren. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurden weitere Such- und Filterfunktionen zum <b><span class="uicontrol"> Alle Eigenschaften durchsuchen</span></b> erweiterte Suche. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dieser Abschnitt enthält neue und überarbeitete Inhalte, die die <span class="wintitle"> Profillink</span> und Gerätediagrammoptionen von Drittanbietern. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Optionales Dateinamenelement hinzugefügt <code> PID-ALIAS</code> in der ausgehenden Datei. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Beschreibung wurde überarbeitet und zugehörige Links zur <code> containerSNID</code> Eigenschaft von <code> DIL.create</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Adressierbare Zielgruppenmetriken</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Aktualisiert mit dem erwarteten Format für Mobilgeräte-IDs (DAID), die von <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde ein neuer Eintrag hinzugefügt, der die <span class="keyword"> Experience Cloud</span> <span class="wintitle"> Organisations-ID</span>, einschließlich Informationen darüber, wie Sie sie finden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>wurde aktualisiert, um die <code> DPUUIDS</code> Makro. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Links zu [!DNL Audience Manager] Versionshinweise und Dokumentationsänderungen. Für ein Archiv älterer Änderungen finden Sie unter [!DNL Experience Cloud] Ebene, siehe [Frühere Versionshinweise](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) Abschnitt.
