---
description: Eine Liste neuer und überarbeiteter Dokumentationen des Audience Managers, die 2015 veröffentlicht wurden. Enthält kleinere Aktualisierungen oder Änderungen am Audience Manager-Handbuch, die möglicherweise nicht in den Experience Cloud-Versionshinweisen enthalten sind.
...
Eine Liste neuer und überarbeiteter Dokumentationen des Audience Managers, die 2015 veröffentlicht wurden. Enthält kleinere Aktualisierungen oder Änderungen am Audience Manager-Handbuch, die möglicherweise nicht in den Experience Cloud-Versionshinweisen enthalten sind.
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Textänderungen und -aktualisierungen. Außerdem enthielt neue Schlüssel-Wert-Paare, die für die Verwendung und Anzeige lesbarer Datennamen in den <span class="wintitle"> Advertising Analytics</span> -Berichten erforderlich sind. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Analytics</span> -Kunden müssen bei Verwendung des Master-Marketing-Profils einen Integrationscode festlegen und deklarierte IDs über den Besucher-ID-Dienst an <span class="keyword"> Audience Manager</span> übergeben. </p> <p>Dieses Dokument ist veraltet und wurde durch <a href="../features/profile-merge-rules/merge-rules-start.md"> Erstellen einer geräteübergreifenden Daten-Source</a> ersetzt. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Bringen Sie Ihre <span class="keyword"> DoubleClick-Kampagnenmanagerdaten</span> in den <span class="keyword"> Audience Manager</span>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md"> API-Methoden und Code für den Datenerfassungsserver (DCS)</a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741">Der Variable <code> declaredId</code> wurde ein Hinweis hinzugefügt. Bei Verwendung des Besucher-ID-Diensts setzen Sie die ID auf <code> setCustomerIDs</code> anstelle von DIL. Siehe <a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html" format="https" scope="external"> Kunden-IDs und Authentifizierungsstatus</a>. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E3544AE9796D43408FBEC64CA5B493D8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Audience Marketplace ermöglicht Datenanbietern und -käufern, Datengeschäfte selbstständig und mit minimalem Aufwand durchzuführen. Dies geschieht durch Bereitstellung spezieller Funktionen, die je nach Ihrer Rolle als Datenkäufer oder Datenverkäufer variieren. </td> 
  </tr> 
  <tr> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neues Thema. </p> <p>Geändert zu <a href="../faq/faq-privacy.md"> FAQ zu Datenschutz und Datenaufbewahrung</a> (12.12.2016). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_14B4E7BC63394E1F966035B977F90D58"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/reporting-file-transfer-timeframe.md"> Richtlinien für Berichterstellung und Dateiübertragung - Zeitrahmen </a> </p> </td> 
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Text wurde aktualisiert und es wurden Illustrationen hinzugefügt. </p> <p>Dieses Dokument ist veraltet und wurde durch den Eintrag <a href="../features/profile-merge-rules/merge-rules-overview.md"> Profillink</a> ersetzt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> Neuigkeit und Häufigkeit </a> </p> </td> 
