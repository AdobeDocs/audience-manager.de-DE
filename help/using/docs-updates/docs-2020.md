...
| Thema | Beschreibung |
|----|----|
| [Vorhersagekräftige Zielgruppen](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Modellklone für prädiktive Zielgruppen**: Sie können jetzt vorhandene Modelle klonen und ihre Konfiguration an Ihre Anforderungen anpassen. Weitere Informationen finden Sie unter [Klonen und Bearbeiten von Predictive Audience-Modellen](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) .</li><li>**Batch-Klassifizierung von Predictive Audiences**: Neben der Klassifizierung von Besuchern in unterschiedlichen Personas in Echtzeit unterstützen Predictive Audiences jetzt auch die Batch-Klassifizierung, sodass Sie integrierte Benutzer klassifizieren und für Batch-Ziele aktivieren können.</li></ul> |
| [Überlagerungsberichte](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Wir haben die Methodik zur Berechnung von Überlagerungsberichten aktualisiert ([Eigenschaften-zu-Eigenschaften](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-zu-Eigenschaft](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-zu-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Die Berechnung von Überlagerungsberichten basiert jetzt auf eindeutigen Berichten und MinHash-Signaturen (anstelle von [1/54 Daten-Sampling](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Audience Manager-Plug-In für IAB TCF](../overview/data-security-and-privacy/aam-iab-plugin.md) | Adobe konzentriert sich weiterhin auf Privacy by Design. Ab dem 10. Juni 2020 aktualisieren wir das Audience Manager-Plugin für IAB TCF auf die IAB Transparency &amp; Consent Framework (TCF)-Version 2.0. Kunden, die das Audience Manager-Plug-in für IAB TCF implementiert haben, müssen bis zum 15. August 2020 auf Version 2.0 aktualisieren, um die Funktion weiterhin nutzen zu können. Ab dem 15. August 2020 wird Version 1.1 nicht mehr unterstützt und nicht mehr unterstützt. |
