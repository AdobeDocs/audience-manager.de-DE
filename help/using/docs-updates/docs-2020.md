...
| [Neue SFTP-Server](../faq/faq-data-collection.md) | Sie können jetzt die neuen [!DNL SFTP] Server (`ftp-in-gtw` und `ftp-out-gtw`) verwenden, die [!DNL AWS SFTP Gateway] überflüssig sind [!DNL S3]. |
