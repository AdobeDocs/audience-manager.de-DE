...
| Thema | Beschreibung |
|----|----|
| [Vorhersagekräftige Zielgruppen](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Modellklonen von Predictive Audiences**: Sie können jetzt vorhandene Modelle klonen und ihre Konfiguration an Ihre Anforderungen anpassen. Lesen [Klonen und Bearbeiten von Predictive Audience-Modellen](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) für weitere Informationen.</li><li>**Batch-Klassifizierung von Predictive Audiences**: Neben der Klassifizierung von Besuchern in verschiedenen Personas in Echtzeit unterstützen Predictive Audiences jetzt die Batch-Klassifizierung, sodass Sie integrierte Benutzer klassifizieren und für Batch-Ziele aktivieren können.</li></ul> |
| [Überlagerungsberichte](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Wir haben die Methode zur Berechnung von Überlagerungsberichten aktualisiert ([Eigenschaften-zu-Eigenschaften](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-zu-Eigenschaft](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment zu Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Die Berechnung von Overlap Reports basiert jetzt auf eindeutigen Berichten und MinHash-Signaturen (anstatt [1/54 Datenstichproben](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Eingehende S3-Dateinamen](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) und [Eingehende FTP-Dateinamen](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Wir haben die Definitionen aktualisiert und Beispiele für die `DPID` und `DPID_TARGET_DATA_OWNER` in der Syntax des Dateinamens. |

## August 2020 {#aam-august-updates}

| Thema | Beschreibung |
|---- |----|
| [Google-Kundenabgleich für personenbasierte Ziele](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Sie können jetzt [!UICONTROL People-Based Destinations] , um Benutzer über anzusprechen [!DNL Google Customer Match]. Bevor Sie [!UICONTROL People-Based Destinations] , um Ihre Erstanbieter-Zielgruppensegmente an eine [!DNL Google Customer Match] Ziel ist es obligatorisch, dass [!DNL Google] fügt Sie zu ihrer Zulassungsliste hinzu. Überprüfen Sie die [Benutzerbasierte Ziele](../features/destinations/people-based-destinations-prerequisites.md#gcm) Dokumentation . |
| [Neue SFTP-Server](../faq/faq-data-collection.md) | Sie können jetzt die neue [!DNL SFTP] Server ([!DNL ftp-in-gtw] und [!DNL ftp-out-gtw]), die [!DNL AWS SFTP Gateway] over [!DNL S3]. |
...
| Thema | Beschreibung |
|---- |----|
| [Freigabe von Zielgruppen zwischen Audience Manager und Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | Der neue Abschnitt, **Grundlegendes zu Segmentpopulationsunterschieden zwischen Audience Manager und Experience Platform** beschreibt mögliche Gründe, warum die Populationszahlen zwischen Experience Platform und Audience Manager variieren können. |
| [Erste Schritte mit Audience Manager-REST-APIs](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Es wurde ein neuer Abschnitt hinzugefügt, **JWT (Service Account)-Authentifizierung mit[!DNL Adobe I/O]**. In diesem Abschnitt erfahren Sie, wie Sie sich bei den Audience Manager-APIs mit [!DNL Adobe I/O]. |
