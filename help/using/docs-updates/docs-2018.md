...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Weitere Informationen zum Regelsatz, dem IRIS beim Senden von Segmenten an Ziele folgt, finden Sie unter <b>Zuordnungsregeln segmentieren</b> . </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>In den allgemeinen Berichten wurden Definitionen und Beispiele für alle Metriken hinzugefügt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md"> Verbesserungen der Dokumentation für adressierbare Zielgruppen</a> </p> </td> 
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Data Integration Library-API (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Ab Version 8.0 weist <span class="wintitle"> DIL</span> eine feste Abhängigkeit vom <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, Version 3.3 oder höher auf. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Grundlegendes zur Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p><a href="../dil/dil-overview.md"> Abrufen und Implementieren von DIL-Code</a> wurde geändert, um zu berücksichtigen, dass <span class="keyword"> Adobe Experience Platform Launch</span> das bevorzugte Codebereitstellungs-Tool im <span class="keyword"> Experience Cloud</span> ist. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bevor Sie die Audience Manager-Details lesen, empfehlen wir Ihnen, sich das Experience Cloud-Material für die Europäische Datenschutz-Grundverordnung (DSGVO) anzusehen, das auf dieser Seite verlinkt ist. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/aam-gdpr-partners.md"> Aufhebung der Segmentierung durch DSGVO-Partner</a> </p> </td> 
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ab dem 29. März 2018 müssen alle Audience Manager, die sich auf <a href="https://www.ampproject.org/learn/overview/" format="https" scope="external"> Accelerated Mobile Pages</a> (AMP) befinden, die serverseitige Integration nutzen, wenn sie Zielgruppen an Google DoubleClick for Publishers (DFP) senden. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Hinzugefügter Fehler 198: Anforderungen dieses Landes werden von einem Partner blockiert </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde eine Beschränkung von 50.000 für die Anzahl der abgeleiteten Signale hinzugefügt, die Sie verwenden können. </p> </td> 
  </tr> 
 </tbody> 
</table>
