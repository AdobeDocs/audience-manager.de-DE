...
| [Tools zur Massenverwaltung](/help/using/reference/bulk-management-tools/bulk-management-intro.md) | Wir haben eine neue Version des Arbeitsblatts zur Massenverwaltung veröffentlicht, das unter den Betriebssystemen MacOS und Microsoft Windows funktioniert und die Experience Cloud-Anmeldung unterstützt. |
