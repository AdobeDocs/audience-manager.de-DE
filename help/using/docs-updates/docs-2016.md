---
description: Eine Liste neuer und überarbeiteter Dokumentationen des Audience Managers, die 2016 veröffentlicht wurden. Enthält kleinere Aktualisierungen oder Änderungen am Audience Manager-Handbuch, die möglicherweise nicht in den Experience Cloud-Versionshinweisen enthalten sind.
...
Eine Liste neuer und überarbeiteter Dokumentationen des Audience Managers, die 2016 veröffentlicht wurden. Enthält kleinere Aktualisierungen oder Änderungen am Audience Manager-Handbuch, die möglicherweise nicht in den Experience Cloud-Versionshinweisen enthalten sind.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Enthält einen neuen Eintrag zur Whitelist von <span class="keyword"> Audience Manager</span> IP- und FTP-Adressen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sie können eine CSV-Datei für einen Überlagerungsbericht anfordern, wenn dieser Bericht das Limit von 1 Million Datensätzen erreicht. Dateien sind für Berichte zur Segmentüberschneidung, Segment-zu-Merkmal-Überschneidung und zur Eigenschaftenüberschneidung verfügbar. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> behandelt die Authentifizierungsstatus der Besucher-ID <code> UNKNOWN</code> und <code> LOGGED_OUT</code> auf dieselbe Weise. Das Dokument enthält weitere Informationen zur Verarbeitung von <code> setCustomerID</code>-Ereignisaufrufen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neuer Inhalt, der beschreibt, wie Zeitintervalle für <span class="wintitle"> adressierbare Zielgruppen</span> und <span class="wintitle"> Ziele</span> funktionieren. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Was passiert, nachdem ein Anbieter meinen Datenfeed deaktiviert hat </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde überarbeitet, um festzustellen, dass <code> GA.init()</code> nicht mit der neuesten Version des Analytics-Codes von Google, <code> analytics.js</code>, funktioniert. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/amazon-s3.md"> Amazon S3: Info </a> </p> </td> 
   <td colname="col2"> <p>Verschlüsselung der Ruhezeit für Batch-ausgehende Datenübertragungen wurde hinzugefügt. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <i>Diese Funktion wird nicht mehr unterstützt.</i><p>Es wurde überarbeitet, um weitere Informationen zur <span class="keyword"> Adobe Experience Cloud-Gerätekooperation</span> einzuschließen. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> In der Experience Cloud verwendete Cookies</a> </td> 
   <td colname="col2"> Der Wert für die Time-to-Live (TTL) des demdex-Cookies und des Partner-Cookies wurde auf 180 Tage geändert, um den französischen CNIL-Vorschriften zu entsprechen. </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Inhalt wurde aktualisiert und erklärt, warum DIL mit den Methoden <code> GET</code> und <code> POST</code> Daten bei einem Ereignisaufruf sendet. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die <span class="wintitle"> Audience Optimization</span> -Berichte wurden mit kanalübergreifender Konversion, rollenbasierter Zugriffssteuerung, Konversionsgruppen und dem Bericht zu gemeldeten Konversionseigenschaften aktualisiert. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Mit der Option <span class="wintitle"> Kanalübergreifende Konversion</span> in den <span class="wintitle"> Audience Optimization</span> -Berichten können Sie Offline-Konversionen bereitgestellten Online-Impressionen oder -Klicks zuordnen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/audience-optimization-reports/aor-advertisers/reported-conversion-traits.md"> Gemeldete Konversionseigenschaften </a> </p> </td> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Aus der Dokumentation zu <span class="keyword"> Audience Manager</span> im September 2017 entfernt. In die Dokumentation zu <span class="keyword"> Analytics</span> verschoben. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> Erfassen von Kampagnen-Impressionsdaten über Pixelaufrufe </a> </p> </td> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rules-dashboard.md"> Dashboard mit Profilzusammenführungsrichtlinien </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Echtzeit-Freigabe von Audience Manager-Segmenten für Analytics. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Es wurde der neue benannte Operator <code> Matcheswords</code> hinzugefügt. Hier können Sie übereinstimmende Wortmuster ohne regulären Ausdruck angeben. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md"> Namensanforderungen von Amazon S3 für eingehende Datendateien </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md"> FTP-Namensanforderungen für eingehende Datendateien </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/integrating-third-party/rlsa-integration.md"> Segmente an eine Remarketing-Liste für Google AdWords senden </a> </p> </td> 
   <td colname="col2"> <p>Anleitung zum Senden von Segmentdaten an eine Google AdWords-Remarketing-Liste. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/visitor-profile-viewer.md"> Besucherprofil-Betrachter </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Text für <code> declaredId</code> wurde überarbeitet. Kunden-IDs dürfen nur als nicht codierte Werte weitergegeben werden. Ein Codieren der IDs führt zu doppelt codierten Identifikatoren. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Neue Dokumentation, in der die Elemente in einem <span class="wintitle"> Audience Marketplace</span> Abrechnungsbericht aufgeführt und definiert werden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/segment-builder-data.md"> Daten zu Eigenschaften und Segmentgröße im Segmentaufbau </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#marketplace-buyer-details"> Grundlegendes zur Planungsdetails-Seite in Audience Marketplace </a> </p> </td> 
