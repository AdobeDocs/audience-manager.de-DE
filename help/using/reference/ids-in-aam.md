...
| [!DNL ECID], [!DNL MID] | [!DNL Experience Cloud] ID. Die [!DNL Experience Cloud]-ID ([!DNL ECID], veraltete Abkürzungen [!DNL MID] oder [!DNL MCID]) wird mathematisch aus Ihrem [!DNL Organization ID] und dem [!DNL Audience Manager] [!UICONTROL Unique User ID] abgeleitet. Solange diese IDs konstant bleiben, ist die Generierung des richtigen [!DNL ECID] für einen bestimmten Benutzer einfach ein mathematisches Problem. Mit demselben [!DNL Organization ID] und [!DNL Audience Manager] [!DNL UUID] erhalten Sie immer denselben [!DNL ECID] -Wert. Weitere Informationen zu [!DNL ECID] finden Sie in der [Dokumentation zu Cookies und Experience Cloud-ID](https://docs.adobe.com/content/help/en/id-service/using/intro/cookies.html#section-15f69c0bac394b4b9966a23fbc586d17) . | `mid = 08382830887934830189014177072406221371` | In der [!DNL Audience Manager]-Benutzeroberfläche nicht sichtbar. |
