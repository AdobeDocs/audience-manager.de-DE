...
## Auf [!DNL IAB TCF v2.2] {#upgrading}

Kunden, die ein Upgrade ihrer [!DNL Audience Manager Plug-in for IAB TCF] Implementierung von [!DNL IAB TCF] v1.1 bis [!DNL IAB TCF] v2.2 oder Aktivieren von [!DNL IAB TCF] v2.2 zum ersten Mal sollten alle dieselben Richtlinien für Voraussetzungen und Implementierung befolgen, wie unten beschrieben.
...
Benutzer können ihre Auswahl in Form von *Einverständnis* für IAB-Zwecke *Drittanbieter* in der globalen Anbieterliste registriert.
...
Details zu den verschiedenen Zwecken und Berechtigungen, die im IAB TCF v2.2 enthalten sind, finden Sie im Abschnitt [IAB Europe Transparency &amp; Consent Framework Policies](https://iabeurope.eu/iab-europe-transparency-consent-framework-policies/#A_Purposes).
...
* **Sonderzweck 1**: Sicherstellen von Sicherheit, Vermeiden von Betrug und Debugging.
...
>
>Per [IAB-Vorschriften](https://iabeurope.eu/iab-europe-transparency-consent-framework-policies/#Special_Purpose_1__Ensure_security_prevent_fraud_and_debug_), Sonderzweck 1 (Sicherheit gewährleisten, Betrug verhindern und Debugging) wird immer zugestimmt und Benutzer können keine Einwände dagegen erheben.
...
Die Audience Manager-Integration mit IAB TCF v2.2 unterstützt das Anhängen der Zustimmung an Informationen, die an gesendet werden [URL-Ziele](../../features/destinations/create-url-destination.md) die mit IAB TCF v2.2 integriert sind. Dieser Vorgang wird jedoch nicht automatisch von Audience Manager ausgeführt, um zu verhindern, dass bestimmte URL-Formate beschädigt werden.
