...
+ Funktionen {#features}
   ...
   + Algorithmische Modelle {#algorithmic-models}
      ...
      + Vorhersagekräftige Zielgruppen {#predictive-audiences}
         ...
         + [Erste Schritte mit vorausschauenden Zielgruppen](features/algorithmic-models/predictive-audiences-start.md)
   ...
   + Data Explorer {#data-explorer}
      + [Data Explorer - Übersicht, Vorteile und Anwendungsfälle](features/data-explorer/data-explorer-overview.md)
      + [Grundlagen zu Signalen](features/data-explorer/data-explorer-understanding-signals.md)
   ...
   + Ziele {#destinations}
      ...
      + Gerätebasierte Ziele (Server-zu-Server) {#device-based}
         ...
         + [Amazon Advertising als gerätebasiertes Selbstbedienungsziel konfigurieren](features/destinations/amazon-advertising.md)
      ...
      + Referenz: Ziele {#destinations-reference}
         + [Zielgenerator](features/destinations/destination-builder.md)
   ...
   + Profilzusammenführungsrichtlinien {#profile-merge-rules}
      ...
      + [Dashboard für Profilzusammenführungsrichtlinien](features/profile-merge-rules/merge-rules-dashboard.md)
      + [Definierte Optionen für Profilzusammenführungsregeln](features/profile-merge-rules/merge-rule-definitions.md)
   ...
   + Eigenschaften {#traits}
      ...
      + [Segment und Eigenschaftszeit - Erklärung](features/traits/segment-ttl-explained.md)
      ...
      + [Referenz zu Eigenschafts- und Segmentqualifikationen](features/traits/trait-and-segment-qualification-reference.md)
   + [Besucherprofil-Betrachter](features/visitor-profile-viewer.md)
+ Berichterstellung {#reporting}
   ...
   + Berichte zur Zielgruppenoptimierung {#audience-optimization-reports}
      ...
      + Zielgruppenoptimierung für Advertiser {#audience-optimization-advertisers}
         + [Übersicht über Audience Optimization für Advertiser](reporting/audience-optimization-reports/aor-advertisers/aor-advertisers.md)
      ...
      + Zielgruppenoptimierung für Publisher {#audience-optimization-publishers}
         + [Übersicht über Audience Optimization für Herausgeber](reporting/audience-optimization-reports/aor-publishers/aor-publishers.md)
         ...
         + [Überschneidung von Anzeigeneinheiten](reporting/audience-optimization-reports/aor-publishers/publisher-ad-unit-overlap.md)
         + [Überschneidung von Segmenten mit Anzeigeneinheiten](reporting/audience-optimization-reports/aor-publishers/publisher-segment-ad-unit-overlap.md)
      ...
      + Daten- und Metadatendateien für Berichte zur Zielgruppenoptimierung und ausführbare Protokolldateien {#data-and-metadata-files}
         ...
         + [Datendateien für Audience Optimization-Berichte und ausführbare Protokolldateien](reporting/audience-optimization-reports/metadata-files-intro/datafiles-intro.md)
...
+ API- und SDK-Code {#api-and-sdk-code}
   + [Überblick über API- und SDK-Code](api/api.md)
   + [Migration des Audience Manager-API-Codes](api/api-swagger-migration.md)
   + API-Methoden und Code für Datenerfassungs-Server (DCS) {#dcs}
      ...
      + DCS-APIs {#dcs-apis}
         ...
         + [Abrufen von Benutzer-IDs und Regionen über den Adobe Experience Platform Identity-Dienst](api/dcs-intro/dcs-s2s/dcs-mcid-ids.md)
      ...
      + DCS-API-Referenz {#dcs-api-reference}
         ...
         + [ID-Überwachung und -Auf die Blockierungsliste setz](api/dcs-intro/dcs-api-reference/id-monitoring-denylisting.md)
   ...
   + REST-APIs {#rest-apis}
      ...
      + [API-Methoden für Data Integration Librarys](api/rest-api-main/aam-api-dil-methods.md)
      ...
      + API-Methoden für Ziele {#destination-api-methods}
         + [Übersicht über die API-Methoden für Ziele](api/rest-api-main/aam-api-destinations/aam-api-destinations.md)
...
+ Implementierungs- und Integrationshandbücher {#implementation-integration-guides}
   ...
   + Empfangen von Zielgruppendaten {#receiving-audience-data}
      ...
      + Ausgehende Batch-Datenübertragungen {#batch-outbound-data-transfers}
         + [Ausgehende Batch-Datenübertragungen - Übersicht](integration/receiving-audience-data/batch-outbound-transfers/batch-outbound-overview.md)
...
+ Referenz {#reference}
   ...
   + Tools zur Massenverwaltung {#bulk-management-tools}
      ...
      + [Tipps zur Fehlerbehebung für Tools zur Massenverwaltung](reference/bulk-management-tools/bulk-troubleshooting.md)
      + [Tools für die Massenverwaltung - Glossar](reference/bulk-management-tools/bulk-management-glossary.md)
   ...
   + [Authentifizierungsstatus von Besuchern im Audience Manager](reference/visitor-authentication-states.md)
+ Häufig gestellte Fragen (FAQ) {#faqs}
   + [Häufig gestellte Fragen zu Audience Managern - Überblick](faq/faq-overview.md)
...
+ Häufigste Support-Anfragen {#top-support-issues}
   ...
   + [Sollte ich meine von Audience Manager Audience Lab zugeordneten Segmente auf der Zieldetailseite sehen?](/help/using/support-issues/should-i-see-audience-lab-mapped-segments-on-the-destination-page.md)
