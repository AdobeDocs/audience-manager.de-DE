...
+ [Weiterentwicklungsleitfaden für Real-Time CDP](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/evolution/aam-to-rtcdp.html)
...
+ Funktionen{#features}
   ...
   + Segmente{#segments}
      ...
      + [Referenz zur Trait- und Segmentqualifikation](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/traits/trait-and-segment-qualification-reference.html)
