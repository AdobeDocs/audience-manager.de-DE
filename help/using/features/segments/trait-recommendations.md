...
Beginnen Sie mit dem Video "Trait Recommendations" und lesen Sie dann, um weitere Informationen anzuzeigen.
...
2. Fügen Sie in der **Dropdown-Liste Eigenschaften** mindestens eine Eigenschaft zur Segmentregel hinzu.
3. Sie können nun empfohlene Eigenschaften sehen, die den Eigenschaften ähnlich sind, die Sie der Segmentregel hinzugefügt haben. Blättern Sie nach unten, um alle empfohlenen Eigenschaften anzuzeigen.
...
5. Um die empfohlene Eigenschaft der Segmentregel hinzuzufügen, klicken Sie auf das **Symbol +** .
