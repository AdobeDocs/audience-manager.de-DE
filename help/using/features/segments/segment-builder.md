...
| Daten zu tatsächlichen und geschätzten Segmentgrößen | Siehe [Eigenschaften von Eigenschaften und Segmentpopulationen im Segmentaufbau](segment-builder-data.md). |
...
|---|---|
| **Suche nach Zielname** | Ermöglicht die Suche nach einem bestimmten Ziel nach Name. Um zu suchen, beginnen Sie mit der Eingabe. Das Feld wird basierend auf Ihren Suchbegriffen automatisch vervollständigt. Klicken Sie auf, **[!UICONTROL Add Destination]** wenn Sie fertig sind. |
