...
* Wenn Sie [!UICONTROL DCS API] in Echtzeit zu integrierten regelbasierten Eigenschaften verwenden, können Sie das Segment mithilfe der [!UICONTROL AND NOT]-Logik auslösen. Lesen Sie mehr über das Senden von Daten an die DCS-API[. &#x200B;](../../api/dcs-intro/dcs-event-calls/dcs-url-send.md)
