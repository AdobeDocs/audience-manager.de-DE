...
<table id="table_43F4321BEA6A4D1BBDFE2E9FB4402914"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ungültiger <code> d_orgid</code> -Wert (keine Konfiguration für diese Organisations-ID gefunden): <code><i>ID</i></code> </p> </td> 
...
<table id="table_A50C284AB84F48A79B01223D991884A2"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Tag zum Ausschluss für ID- <code><i>ID gefunden</i></code> </p> </td> 
...
<table id="table_CFF2252A3CC54960802905454A867D7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Migration von <code><i>ID</i></code> zu <code><i>ID</i></code>konnte nicht durchgeführt werden, da das Lesen des Profils für die <code><i>ID fehlgeschlagen ist.</i></code> </p> </td>
   <td colname="col3"> <p>Wenn Sie diesen Fehler erhalten, treten bei unserem Datenspeicher (<span class="wintitle"> PCS</span>) möglicherweise Skalierungsprobleme auf. Wenden Sie sich an Ihren Adobe-Kundenbetreuer, wenn das Problem weiterhin besteht. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_31F1593C46804DDBA2E9BEDE83F2417F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Maximale Anzahl der Kunden-IDs überschritten. Maximal zulässig ist <code><i>maximal zulässig</i></code>. Der gefundene Wert ist der <code><i>maximal gefundene</i></code>Wert.</p> </td> 
