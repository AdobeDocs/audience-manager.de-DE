...
### [!DNL URLs] für die OAuth]{type=positive}Server-zu-Server-Authentifizierung [!BADGE empfohlen) und die [!DNL JWT]-Authentifizierung [!BADGE veraltet]{type=negative} über Adobe Developer {#request-urls-jwt}
