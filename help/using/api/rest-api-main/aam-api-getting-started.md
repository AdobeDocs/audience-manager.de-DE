...
* [OAuth-Authentifizierung (nicht mehr unterstützt)](#oauth). Diese Methode wird nicht mehr unterstützt, Kunden mit vorhandenen OAuth-Integrationen können diese Methode weiterhin verwenden.
