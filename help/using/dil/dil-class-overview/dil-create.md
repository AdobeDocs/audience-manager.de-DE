 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 
    ...
    </ul> <p> <p>Wichtig:  Verwenden Sie nur nicht kodierte Werte für Ihre IDs. Ein Codieren der führt zu doppelt codierten Identifikatoren. </p> </p> <p> <p>Hinweis:  Wenn Sie den Adobe Experience Platform Identity-Dienst </a> verwenden, legen Sie Kunden-IDs mit der Methode <code> setCustomerIDs </code> anstelle von <span class="wintitle"> DIL </span> fest. <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"> Siehe <a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html" format="https" scope="external"> Kunden-IDs und Authentifizierungsstatus </a>. </a></p> </p> </td> 
  </tr> 
  <tr> 
